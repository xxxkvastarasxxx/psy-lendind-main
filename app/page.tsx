...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sage-50 via-cream-50 to-mint-50 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(circle at 20% 50%, rgba(168, 196, 181, 0.4) 0%, transparent 60%)",
              "radial-gradient(circle at 80% 20%, rgba(198, 208, 191, 0.4) 0%, transparent 60%)",
              "radial-gradient(circle at 40% 80%, rgba(168, 196, 181, 0.4) 0%, transparent 60%)",
              "radial-gradient(circle at 60% 30%, rgba(139, 180, 161, 0.3) 0%, transparent 60%)",
              "radial-gradient(circle at 20% 50%, rgba(168, 196, 181, 0.4) 0%, transparent 60%)",
            ],
          }}
          transition={{
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(168, 196, 181, 0.4) 0%, rgba(198, 208, 191, 0.2) 50%, transparent 100%)",
            filter: "blur(40px)",
          }}
          animate={{
            x: [0, 50, -30, 0],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(198, 208, 191, 0.4) 0%, rgba(168, 196, 181, 0.2) 50%, transparent 100%)",
            filter: "blur(50px)",
          }}
          animate={{
            x: [0, -40, 60, 0],
      ...
      {/* Geometric shapes */}
      <motion.div
        className="absolute bottom-1/3 right-1/3 w-24 h-24 border border-mint-300/20"
      ...
      {/* Light rays */}
      <motion.div
        className="absolute top-0 left-1/4 w-px h-full bg-gradient-to-b from-transparent via-sage-300/20 to-transparent"
        animate={{
          opacity: [0, 0.5, 0],
          scaleY: [0.5, 1, 0.5],
        }}
      ...
      <motion.div
        className="absolute top-0 right-1/3 w-px h-full bg-gradient-to-b from-transparent via-mint-300/20 to-transparent"
        animate={{
          opacity: [0, 0.4, 0],
          scaleY: [0.3, 1, 0.3],
        }}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 py-4 sm:py-2">
          <motion.div variants={fadeInUp} className="mb-4 sm:mb-4 md:mb-6">
            <h1 className="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-sage-800 mb-3 sm:mb-2 md:mb-3 leading-tight px-1">
              Скорая помощь
              <span className="block text-sage-600 font-normal mt-1 sm:mt-1 md:mt-2">
                при измене
              </span>
            </h1>
            <p className="text-base sm:text-base md:text-lg text-sage-700 max-w-3xl mx-auto leading-relaxed font-light px-2 sm:px-4 mt-3 sm:mt-2">
          ...
          <motion.div
            className="absolute top-20 left-10 w-32 h-32 bg-sage-200/20 rounded-full blur-2xl"
            animate={{
              y: [0, -30, 0],
              x: [0, 20, 0],
              opacity: [0.2, 0.4, 0.2],
          ...
          />
          <motion.div
            className="absolute top-40 right-20 w-24 h-24 bg-mint-200/25 rounded-full blur-xl"
            animate={{
              y: [0, 25, 0],
              x: [0, -15, 0],
              opacity: [0.3, 0.6, 0.3],
          ...
          />
          <motion.div
            className="absolute bottom-40 right-10 w-40 h-40 bg-cream-200/15 rounded-full blur-3xl"
            animate={{
              y: [0, 20, 0],
              opacity: [0.1, 0.3, 0.1],
              scale: [1, 0.8, 1],
          ...
          <motion.div variants={fadeInUp} className="mb-5 sm:mb-6 px-0 sm:px-2">
            <div className="relative max-w-lg sm:max-w-xl md:max-w-2xl mx-auto rounded-lg sm:rounded-xl md:rounded-3xl overflow-hidden shadow-lg sm:shadow-xl md:shadow-2xl bg-white/30 backdrop-blur-sm border border-sage-200/50">
              <div className="aspect-video bg-gradient-to-br from-sage-100 to-mint-100 flex items-center justify-center relative">
                {!isVideoPlaying ? (
                  <>
                    <video
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                    >
                      <Play className="w-6 h-6 sm:w-6 sm:h-6 md:w-8 md:h-8 text-sage-700 ml-1 group-hover:text-sage-800" />
                    </motion.button>
                  </>
                ) : (
                  <video
          ...
          <motion.div variants={fadeInUp} className="mb-5 sm:mb-4 md:mb-6">
            <div className="flex flex-wrap justify-center gap-5 sm:gap-6 text-sage-600">
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 sm:w-2.5 sm:h-2.5 bg-sage-400 rounded-full"></div>
                <span className="text-sm sm:text-sm font-medium">25 лет опыта</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 sm:w-2.5 sm:h-2.5 bg-mint-400 rounded-full"></div>
                <span className="text-sm sm:text-sm font-medium">1000+ женщин</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-3 h-3 sm:w-2.5 sm:h-2.5 bg-cream-400 rounded-full"></div>
          ...
          <motion.div variants={fadeInUp}>
            <motion.button
              className="bg-gradient-to-r from-sage-500 to-sage-600 text-white px-7 sm:px-8 py-3 sm:py-3 rounded-full text-base sm:text-base font-medium hover:from-sage-600 hover:to-sage-700 transition-all duration-700 shadow-lg hover:shadow-xl"
      ...
      <motion.section
        ...
        style={{
          background: `linear-gradient(135deg, 
            ...
            rgba(240, 245, 241, 0.9) 50%, 
            rgba(235, 242, 237, 0.8) 100%)`,
        }}
      >
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-sage-800 mb-6 sm:mb-8">
              Внутри вас сейчас хаос
            </h2>
            <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-sage-400 to-mint-400 mx-auto rounded-full mb-8 sm:mb-12"></div>
          </motion.div>
          ...
          >
            <p className="text-lg sm:text-xl text-sage-700 leading-relaxed max-w-3xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="mt-12 sm:mt-16">
            <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
              {[
                ...
                <motion.div
                  key={index}
                  className="bg-white/70 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-sage-200/40 shadow-lg"
                  variants={fadeInUp}
      ...
      <motion.section
        ...
        style={{
          background: `linear-gradient(135deg, 
            rgba(168, 196, 181, 0.1) 0%, 
            rgba(198, 208, 191, 0.15) 50%, 
            rgba(168, 196, 181, 0.1) 100%)`,
        }}
      >
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12 sm:mb-16"
          >
            <p className="text-lg sm:text-xl text-sage-700 leading-relaxed max-w-3xl mx-auto mb-8 sm:mb-12">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
            <motion.div
              variants={fadeInUp}
              className="bg-white/80 backdrop-blur-sm p-8 sm:p-10 rounded-3xl border border-sage-200/50 shadow-xl"
              whileHover={{ scale: 1.02, y: -5 }}
            >
              <h3 className="text-xl sm:text-2xl font-light text-sage-800 mb-6 sm:mb-8 text-center">
                Сомнения в партнере:
              </h3>
              <div className="space-y-4 sm:space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-sage-200 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <doubt.icon className="w-3 h-3 text-sage-600" />
                    </div>
                    <p className="text-sage-700 leading-relaxed text-sm sm:text-base">
                      {doubt.text}
                    </p>
            ...
            >
              ...
              <div className="space-y-4 sm:space-y-6">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-mint-200 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <doubt.icon className="w-3 h-3 text-mint-600" />
                    </div>
                    <p className="text-sage-700 leading-relaxed text-sm sm:text-base">
                      {doubt.text}
                    </p>
          ...
          >
            <div className="bg-gradient-to-r from-sage-100/80 to-mint-100/80 backdrop-blur-sm p-8 sm:p-10 rounded-3xl border border-sage-200/50 shadow-lg">
              <p className="text-base sm:text-lg text-sage-700 leading-relaxed max-w-4xl mx-auto mb-6">
              ...
              <p className="text-base sm:text-lg text-sage-700 leading-relaxed max-w-4xl mx-auto">
      ...
      >
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.div
            ...
            className="text-center mb-12 sm:mb-16"
          >
            <p className="text-lg sm:text-xl text-sage-700 leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            {[
              ...
              >
                <div className="flex items-center space-x-4 min-h-[40px]">
                  ...
                  <p className="text-sage-700 leading-relaxed text-sm sm:text-base my-auto">
                    {item.text}
                  </p>
                </div>
              </motion.div>
          ...
          <motion.div variants={fadeInUp} className="mt-12 text-center">
            <p className="text-lg sm:text-xl text-sage-700 leading-relaxed font-medium">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-sage-400 to-mint-400 mx-auto rounded-full"></div>
          </motion.div>
          ...
          <div className="space-y-8 sm:space-y-12">
            {[
              ...
              },
              {
                ...
                icon: Sparkles,
                color: "from-sage-400 to-mint-500",
              },
              {
              ...
              <motion.div
                key={index}
                variants={fadeInUp}
                className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 sm:p-10 border border-sage-200/50 shadow-xl hover:shadow-2xl transition-all duration-700"
              ...
              >
                <div className="flex flex-col sm:flex-row items-start space-y-6 sm:space-y-0 sm:space-x-6">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-light text-sage-800 mb-4 sm:mb-6">
                      {module.title}
                    </h3>
                    <h4 className="text-base sm:text-lg font-medium text-sage-700 mb-3 sm:mb-4">
                      Что вы получите:
                    </h4>
      ...
      <motion.section
        ...
        style={{
          background: `linear-gradient(135deg, 
            rgba(248, 250, 248, 0.9) 0%, 
            rgba(240, 245, 241, 0.95) 50%, 
            rgba(235, 242, 237, 0.9) 100%)`,
        }}
      >
          ...
          <motion.div variants={fadeInUp} className="space-y-6 sm:space-y-8">
            {[
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-sage-200 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <result.icon className="w-4 h-4 text-sage-600" />
                  </div>
                  <div>
                    <h3 className="text-base sm:text-lg font-medium text-sage-800 mb-2">
                      {result.title}
                    </h3>
                    <p className="text-sage-700 leading-relaxed text-sm sm:text-base">
                      {result.text}
      ...
      <motion.section
        ...
        style={{
          background: `linear-gradient(135deg, 
            rgba(168, 196, 181, 0.15) 0%, 
            rgba(198, 208, 191, 0.2) 50%, 
            rgba(168, 196, 181, 0.15) 100%)`,
        }}
      >
        <div className="max-w-4xl mx-auto">
          <motion.div
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="mt-12">
            <div className="bg-gradient-to-r from-sage-100/80 to-mint-100/80 backdrop-blur-sm p-8 sm:p-10 rounded-3xl border border-sage-200/50 shadow-lg">
              <p className="text-base sm:text-lg text-sage-700 leading-relaxed text-center">
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="w-16 sm:w-24 h-1 bg-gradient-to-r from-sage-400 to-mint-400 mx-auto rounded-full mb-6 sm:mb-8"></div>
            <div className="space-y-3 sm:space-y-4">
              <p className="text-lg sm:text-xl text-sage-700">
                Полная стоимость курса:{" "}
                <span className="line-through text-sage-500">$249</span>
              </p>
              <p className="text-xl sm:text-2xl text-sage-600 font-medium">
                Специальное предложение:{" "}
                <span className="text-3xl sm:text-4xl font-light text-sage-700">
                  $49
                </span>
              </p>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
            <motion.div
              variants={fadeInUp}
              className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 sm:p-10 border border-sage-200/60 shadow-xl flex flex-col h-full"
              whileHover={{ scale: 1.02, y: -5 }}
            >
              <div className="text-center mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-light text-sage-800 mb-2">
                  Стандарт
                </h3>
                <div className="text-3xl sm:text-4xl font-light text-sage-700">
                  $49
                </div>
              </div>
              ...
              <div className="mt-auto">
                <motion.button
                  className="w-full bg-gradient-to-r from-sage-500 to-sage-600 text-white py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-medium hover:from-sage-600 hover:to-sage-700 transition-all duration-700 shadow-lg hover:shadow-xl"
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                >
                  ЗАПИСАТЬСЯ НА КУРС СТАНДАРТ
                </motion.button>
              </div>
            </motion.div>
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-gradient-to-br from-sage-100/90 to-mint-100/90 backdrop-blur-sm rounded-3xl p-8 sm:p-10 border-2 border-sage-300 shadow-2xl relative overflow-hidden flex flex-col h-full"
              whileHover={{ scale: 1.02, y: -5 }}
            >
              <div className="absolute top-4 right-4 bg-sage-600 text-white px-3 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-medium">
                ПОПУЛЯРНЫЙ
              </div>
              ...
              <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-10">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 text-sage-600 flex-shrink-0 mt-1" />
                  <p className="text-sage-700 leading-relaxed font-medium text-sm sm:text-base">
              ...
              <div className="mt-auto">
                <motion.button
                  className="w-full bg-gradient-to-r from-mint-600 to-sage-600 text-white py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-medium hover:from-mint-700 hover:to-sage-700 transition-all duration-700 shadow-lg hover:shadow-xl"
                  whileHover={{ scale: 1.02, y: -2 }}
                  whileTap={{ scale: 0.98 }}
                >
                  ЗАПИСАТЬСЯ НА КУРС VIP
                </motion.button>
              </div>
            </motion.div>
          </div>
      ...
      <motion.section
        ...
        style={{
          background: `linear-gradient(135deg, 
            ...
            rgba(240, 245, 241, 1) 50%, 
            rgba(235, 242, 237, 0.95) 100%)`,
        }}
      >
        <div className="max-w-4xl mx-auto">
          <motion.div
          ...
          <motion.div
            variants={fadeInUp}
            className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 sm:p-12 border border-sage-200/50 shadow-xl"
          ...
          >
            <div className="flex flex-col lg:flex-row items-center space-y-8 lg:space-y-0 lg:space-x-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                <h3 className="text-2xl sm:text-3xl font-light text-sage-800 mb-3 sm:mb-4">
                  Светлана Цыганова
                </h3>
                <p className="text-lg sm:text-xl text-sage-600 mb-6 sm:mb-8">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {[
                    ...
                    <div key={index} className="flex items-start space-x-3">
                      <div className="w-6 h-6 bg-sage-200 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                        <item.icon className="w-3 h-3 text-sage-600" />
                      </div>
                      <p className="text-sage-700 leading-relaxed text-sm sm:text-base">
                        {item.text}
                      </p>
                ...
                <div className="bg-gradient-to-r from-sage-100/80 to-mint-100/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-sage-200/50">
                  <p className="text-base sm:text-lg text-sage-700 leading-relaxed italic">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="space-y-4 sm:space-y-6">
            {faqData.map((faq, index) => (
              <motion.div
                key={index}
                className="bg-white/80 backdrop-blur-sm rounded-2xl border border-sage-200/50 shadow-lg overflow-hidden"
                variants={fadeInUp}
                transition={{ delay: index * 0.1 }}
              >
                <motion.button
                  className="w-full p-6 sm:p-8 text-left flex items-center justify-between hover:bg-sage-50/50 transition-colors duration-300"
                  onClick={() => toggleFAQ(index)}
                  whileHover={{ scale: 1.01 }}
                >
                  <h3 className="text-base sm:text-lg font-medium text-sage-800 pr-4">
                    {faq.question}
                  </h3>
                  <motion.div
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={fadeInUp}>
            ...
            <div className="space-y-6 sm:space-y-8 mb-8 sm:mb-12">
              <p className="text-lg sm:text-xl text-sage-700 leading-relaxed">
            ...
            <motion.button
              className="bg-gradient-to-r from-sage-600 to-mint-600 text-white px-12 sm:px-16 py-4 sm:py-5 rounded-full text-lg sm:text-xl font-medium hover:from-sage-700 hover:to-mint-700 transition-all duration-700 shadow-xl hover:shadow-2xl mb-6 sm:mb-8"
            ...
            <p className="text-base sm:text-lg text-sage-600 leading-relaxed mb-8 sm:mb-12">
              Позаботьтесь о себе сегодня, чтобы завтра снова почувствовать
              уверенность и радость жизни.
            </p>

            <div className="pt-6 sm:pt-8 border-t border-sage-300">
              <p className="text-sage-600 text-sm sm:text-base">
                📞 Остались вопросы? Напишите нам:
                <a
                  href="mailto:twizug55@gmail.com"
                  className="text-sage-700 hover:text-sage-800 font-medium ml-2 transition-colors duration-300"
                >
                  twizug55@gmail.com
                </a>
              </p>
