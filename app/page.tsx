...
function LandingPageContent() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Каждый из 10 уроков длится 15-20 мин. Курс можно проходить в своем темпе.",
    },
    {
          ...
          <motion.div variants={slideInLeft} className="mb-5 sm:mb-4 md:mb-6">
            ...
            >
              {[
                ...
                { text: "15 тысяч консультаций", color: "bg-gradient-to-r from-secondary to-secondary/80", bgColor: "from-pink-50 to-rose-50" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div variants={fadeInUp} className="mt-12 text-center">
            <p className="text-lg sm:text-xl text-primary/80 leading-relaxed font-medium">
              ...
              выпускницы курса <span className="text-softred-700 font-semibold">"СКОРАЯ ПОМОЩЬ ПРИ ИЗМЕНЕ"</span>.
            </p>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <motion.div variants={fadeInUp} className="text-left mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-prata text-primary mb-6 sm:mb-8 text-center">
            ...
            {[
              {
                ...
                text: "Программа курса опирается на современные исследования в области неврологии травмы, когнитивной психологии и психологии отношений",
                icon: Lightbulb,
              },
              {
          ...
          <motion.div variants={fadeInUp} className="mt-12">
            <div className="bg-gradient-to-r from-secondary/50 to-muted/50 backdrop-blur-sm p-4 sm:p-6 rounded-2xl border border-primary/20">
              <p className="text-base sm:text-lg text-primary/80 leading-relaxed text-left">
                ...
                самопомощи, курс "Скорая помощь при измене" создан
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="space-y-3 sm:space-y-4 mb-8 sm:mb-10 flex-grow">
                    ...
                    {
                      text: "5 видеоуроков с практическими заданиями",
                      icon: "🎯",
                    },
                    {
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={fadeInUp}>
            ...
            <div className="pt-6 sm:pt-8 border-t border-primary/30">
              ...
              <a
                href="https://t.me/SvetlanaTsyganova_bot?start=w41819740"
                className="text-primary/80 hover:text-primary font-medium ml-2 transition-colors duration-300 inline-flex items-center gap-1"
                target="_blank"
                rel="noopener noreferrer"
              >
                @SvetlanaTsyganova_bot
